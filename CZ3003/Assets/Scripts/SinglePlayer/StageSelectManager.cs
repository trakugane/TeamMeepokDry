...
public class StageSelectManager : MonoBehaviour
{
    ...
    void Start()
    {
        stageVal = UserPlayer.userPlayer.stageValue;
    ...
    public void setSelectedStageValue()
    {
        ...
        {
            UserPlayer.userPlayer.selectedStageValue = stageValue + 1;
        ...
        {
            UserPlayer.userPlayer.selectedStageValue = stageValue + 2;
            if (UserPlayer.userPlayer.currProg == UserPlayer.userPlayer.selectedStageValue)
                incrementCounter();
            /*Debug.Log("selectedStageValue: " + Player.userPlayer.selectedStageValue);*/
        }  
        ...
        {
            UserPlayer.userPlayer.selectedStageValue = stageValue + 4;
            if (UserPlayer.userPlayer.currProg == UserPlayer.userPlayer.selectedStageValue)
                incrementCounter();
            /*Debug.Log("selectedStageValue: " + Player.userPlayer.selectedStageValue);*/
        }  
